#
#  Be sure to run `pod spec lint TKVideoPlanet.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "wang animeng"
  # s.authors            = { "wang animeng" => "animeng68@gmail.com" }
...
s.source       = { :git => "https://github.com/BuddyTechnology/planet-sdk-objc.git",:branch => 'master' }
  ...
  # s.resource  = "icon.png"
   s.resources = "sdk/TKResource.bundle"
